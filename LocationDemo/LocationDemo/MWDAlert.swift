...
/// 根据设计自定义设计的Alert样式
class MWDAlert: UIViewController {
    ...
    init() {
        ...
        self.view.backgroundColor = MWDMaskColor
    ...
    private func setupContentView() {
        ...
        contentView.backgroundColor = UIColor.colorWithCustom(255, g: 255, b: 255)
//        contentView.layer.borderColor = 
    ...
    private func setupTitleLabel() {
        ...
        titleLabel.textColor = UIColor.colorWithCustom(14, g: 14, b: 14)
    }
    ...
    private func setupSubtitleTextView() {
        ...
        subTitleTextView.textColor = UIColor.colorWithCustom(179, g: 179, b: 179)
    ...
    private func resizeAndRelayout() {
        ...
        //进入时的动画
//        contentView.transform = CGAffineTransformMakeTranslation(0, -ScreenHeight / 2)
...
extension MWDAlert {
    ...
    //MARK: -alert 方法主体
    func showAlert(title: String = "提示", subTitle: String?,buttonTitle: String = "知道了",otherButtonTitle:String? = nil,action:((OtherButton: UIButton) -> Void)? = nil) {
        userAction = action
...
//            button.backgroundColor = AlertColor
            ...
            button.addTarget(self, action: #selector(MWDAlert.doCancel(_:)), forControlEvents: UIControlEvents.TouchUpInside)
            button.tag = 0
...
//            button.backgroundColor = AlertColor
            ...
            button.addTarget(self, action: #selector(MWDAlert.pressed(_:)), forControlEvents: UIControlEvents.TouchUpInside)
    ...
    func doCancel(sender:UIButton){
        ...
        UIView.animateWithDuration(0.5, delay: 0.0, options: UIViewAnimationOptions.CurveEaseOut, animations: { () -> Void in
            self.view.alpha = 0.0
//            self.contentView.transform = CGAffineTransformMakeTranslation(ScreenHeight, 0)
