...
public class PageMenu: UIViewController, UIScrollViewDelegate, UIGestureRecognizerDelegate {
    ...
    weak var delegate : PageMenuDelegate?
    ...
    public convenience init(viewControllers: [UIViewController], frame: CGRect, pageMenuOptions: [PageMenuOption]?) {
